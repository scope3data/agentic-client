...
const endpoints = makeApi([
  {
    ...
    path: '/',
    alias: 'mcpInitialize',
    description: `Start a new MCP (Model Context Protocol) session. This must be called before using any other MCP tools.
...
&#x60;&#x60;&#x60;`,
    ...
    parameters: [
      {
        name: 'status',
        type: 'Query',
        schema: z.enum(['ACTIVE', 'ARCHIVED', 'ALL']).optional().default('ACTIVE'),
      },
      {
        name: 'name',
        type: 'Query',
      ...
      },
      {
        name: 'take',
        type: 'Query',
        schema: z.number().int().lte(250).optional().default(50),
      },
      {
        name: 'skip',
        type: 'Query',
        schema: z.number().int().gte(0).lte(9007199254740991).optional().default(0),
      },
    ],
    response: z.void(),
    errors: [
  ...
  {
    method: 'get',
    path: '/advertisers/:accountId/audiences',
    alias: 'listAudiences',
    description: `List stored audience metadata for an account.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'take',
  ...
  {
    method: 'post',
    path: '/advertisers/:accountId/audiences/sync',
    alias: 'syncAudiences',
    description: `Sync first-party CRM audiences for an account. Processing is asynchronous — returns 202 with an operation ID.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: SyncAudiencesBody,
      },
    ],
  ...
  {
    method: 'get',
    path: '/advertisers/:advertiserId/accounts/available',
    alias: 'listAvailableAccounts',
    ...
    response: AvailableAccountListResponse,
    errors: [
      {
        status: 400,
        description: `Bad request`,
  ...
  {
    method: 'get',
    path: '/advertisers/:advertiserId/catalogs',
    alias: 'listCatalogs',
      ...
      catalogs: z.array(
        z.object({
          ...
          feed_format: z
            ...
            .nullable(),
          update_frequency: z.enum(['realtime', 'hourly', 'daily', 'weekly']).nullable(),
          item_count: z.number().int().gte(0).lte(9007199254740991),
  ...
  {
    method: 'post',
    path: '/advertisers/:advertiserId/catalogs/sync',
    alias: 'syncCatalogs',
    description: `Inbound ADCP sync_catalogs endpoint. Buyers call this to sync their catalogs and items to the advertiser.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: syncCatalogs_Body,
      },
      {
        name: 'advertiserId',
        type: 'Path',
    ...
    response: z.object({
      catalogs: z.array(
        z.object({
          ...
          item_count: z.number().int().gte(0).lte(9007199254740991).optional(),
          items_approved: z.number().int().gte(0).lte(9007199254740991).optional(),
          items_pending: z.number().int().gte(0).lte(9007199254740991).optional(),
          items_rejected: z.number().int().gte(0).lte(9007199254740991).optional(),
          item_issues: z
            .array(
              z.object({
          ...
          next_fetch_at: z.string().datetime({ offset: true }).optional(),
          error: z.string().optional(),
        })
      ),
  ...
  {
    method: 'get',
    path: '/advertisers/:advertiserId/event-sources',
    alias: 'listEventSources',
    ...
    response: EventSourceListResponse,
    errors: [
      {
        status: 400,
        description: `Bad request`,
  ...
  },
  {
    method: 'post',
    path: '/advertisers/:advertiserId/event-sources',
    alias: 'createEventSource',
    description: `Register an event source for an advertiser. The eventSourceId is referenced by optimization goals on performance campaigns.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: CreateEventSourceInput,
      },
      {
        name: 'advertiserId',
        type: 'Path',
  ...
  {
    method: 'get',
    path: '/advertisers/:advertiserId/event-sources/:eventSourceId',
    alias: 'getEventSource',
    description: `Get a specific event source by its identifier.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'advertiserId',
  ...
  {
    method: 'post',
    path: '/advertisers/:advertiserId/event-sources/sync',
    alias: 'syncEventSources',
    ...
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: SyncEventSourcesRequest,
      },
      {
        name: 'advertiserId',
        type: 'Path',
  ...
  {
    method: 'post',
    path: '/advertisers/:advertiserId/syndicate',
    alias: 'syndicate',
    description: `Toggle syndication ON/OFF for an audience, event source, or catalog to a specific ADCP agent. Returns the syndication status record immediately.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: syndicate_Body,
      },
      {
        name: 'advertiserId',
        type: 'Path',
  ...
  {
    method: 'get',
    path: '/advertisers/:advertiserId/syndication-status',
    alias: 'getSyndicationStatus',
    description: `Query syndication status records for an advertiser, with optional filtering by resource type, resource ID, ADCP agent, and enabled state.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'resource_type',
        type: 'Query',
        schema: z.enum(['AUDIENCE', 'EVENT_SOURCE', 'CATALOG']).optional(),
      },
      {
        name: 'resource_id',
        type: 'Query',
      ...
      },
      {
        name: 'status',
        type: 'Query',
        schema: z.enum(['PENDING', 'SYNCING', 'COMPLETED', 'FAILED', 'DISABLED']).optional(),
      },
      {
        name: 'limit',
        type: 'Query',
    ...
    response: SyndicationStatusListResponse,
    errors: [
      {
        status: 400,
        description: `Bad request`,
  ...
  },
  {
    ...
    path: '/api-call',
    alias: 'mcpApiCall',
    description: `Make REST API calls to any Buyer API endpoint through MCP.
...
&#x60;&#x60;&#x60;`,
  ...
  {
    method: 'post',
    path: '/ask-about-capability',
    alias: 'mcpAskAboutCapability',
    description: `Learn about Buyer API features and capabilities using natural language questions.
...
&#x60;&#x60;&#x60;`,
    ...
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: McpAskCapabilityRequest,
      },
      {
        name: 'mcp-session-id',
        type: 'Header',
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        name: 'status',
        type: 'Query',
        schema: z.enum(['DRAFT', 'ACTIVE', 'PAUSED', 'COMPLETED', 'ARCHIVED']).optional(),
      },
      {
        name: 'take',
        type: 'Query',
  ...
  },
  {
    ...
    description: `Create a new campaign. Optional fields like discoveryId and performanceConfig can be provided at creation or set later via update.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: CreateCampaignBody,
      },
    ],
  ...
  },
  {
    ...
    description: `Update an existing campaign. All fields are optional.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: UpdateCampaignBody,
      },
      {
        name: 'campaignId',
        type: 'Path',
  ...
  {
    method: 'post',
    path: '/campaigns/:campaignId/execute',
    alias: 'executeCampaign',
    ...
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: z.object({ debug: z.boolean() }).partial().passthrough(),
      },
      {
        name: 'advertiserId',
        type: 'Path',
    ...
    response: CampaignStatusChangeResponse,
    errors: [
      {
        status: 400,
        description: `Bad request`,
  ...
  {
    method: 'post',
    path: '/discovery/:discoveryId/apply-proposal',
    alias: 'applyProposal',
  ...
  {
    method: 'get',
    path: '/discovery/:discoveryId/discover-products',
    alias: 'browseProducts',
    ...
    parameters: [
      {
        name: 'groupLimit',
        type: 'Query',
        schema: z.number().int().lte(10).optional().default(10),
      },
      {
        name: 'groupOffset',
        type: 'Query',
      ...
      },
      {
        ...
        type: 'Query',
        schema: z.number().int().lte(15).optional().default(10),
      },
      {
        name: 'productOffset',
        type: 'Query',
      ...
      },
      {
        name: 'pricingModel',
        type: 'Query',
        schema: z.enum(['cpm', 'vcpm', 'cpc', 'cpcv', 'cpv', 'cpp', 'flat_rate']).optional(),
      },
      {
        name: 'salesAgentIds',
        type: 'Query',
        schema: salesAgentIds,
      },
      {
        name: 'salesAgentNames',
        type: 'Query',
        schema: salesAgentIds,
      },
      {
    ...
    response: DiscoverProductsResponse,
    errors: [
      {
        status: 400,
        description: `Bad request`,
  ...
  {
    method: 'get',
    path: '/discovery/:discoveryId/products',
    alias: 'getProducts',
    ...
    response: SessionProductsResponse,
    errors: [
      {
        status: 400,
        description: `Bad request`,
  ...
  {
    method: 'post',
    path: '/discovery/discover-products',
    alias: 'discoverProducts',
  ...
  },
  {
    ...
    alias: 'getReportingMetrics',
    description: `Get reporting metrics across all advertisers and campaigns.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'advertiserId',
      ...
      },
      {
        name: 'days',
        type: 'Query',
        schema: z.number().int().gte(0).lte(90).optional().default(7),
      },
      {
        name: 'view',
        type: 'Query',
        schema: z.enum(['summary', 'timeseries']).optional().default('summary'),
      },
      {
        name: 'download',
        type: 'Query',
  ...
  },
  {
    method: 'get',
    path: '/sales-agents',
    alias: 'listSalesAgents',
    description: `List sales agents visible to the buyer, with optional filtering by status and relationship.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'status',
        type: 'Query',
        schema: z.enum(['PENDING', 'ACTIVE']).optional(),
      },
      {
        name: 'relationship',
        type: 'Query',
        schema: z.enum(['SELF', 'MARKETPLACE']).optional(),
      },
      {
        name: 'name',
        type: 'Query',
      ...
      },
      {
        name: 'limit',
        type: 'Query',
        schema: z.number().int().lte(9007199254740991).optional(),
      },
      {
        name: 'offset',
        type: 'Query',
        schema: z.number().int().gte(0).lte(9007199254740991).optional(),
      },
    ],
    response: AgentList,
    errors: [
  ...
  {
    method: 'post',
    path: '/sales-agents/:agentId/accounts',
    alias: 'registerSalesAgentAccount',
    description: `Register an account with a sales agent for an advertiser. Requires an advertiser seat ID and account credentials.`,
    requestFormat: 'json',
    parameters: [
      {
        name: 'body',
        type: 'Body',
        schema: registerSalesAgentAccount_Body,
      },
      {
        name: 'agentId',
        type: 'Path',
