...
export class ServiceTokensResource {
   ...
   */
  async create(
    params: operations['service_token_create']['requestBody']['content']['application/json']
  ): Promise<operations['service_token_create']['responses'][200]['content']['application/json']> {
   ...
   */
  async list(
    params: operations['service_token_list']['requestBody']['content']['application/json']
  ): Promise<operations['service_token_list']['responses'][200]['content']['application/json']> {
   ...
   */
  async get(
    params: operations['service_token_get']['requestBody']['content']['application/json']
  ): Promise<operations['service_token_get']['responses'][200]['content']['application/json']> {
   ...
   */
  async update(
    params: operations['service_token_update']['requestBody']['content']['application/json']
  ): Promise<operations['service_token_update']['responses'][200]['content']['application/json']> {
   ...
   */
  async archive(
    params: operations['service_token_archive']['requestBody']['content']['application/json']
  ): Promise<operations['service_token_archive']['responses'][200]['content']['application/json']> {
