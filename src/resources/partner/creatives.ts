...
export class CreativesResource {
   ...
   */
  async syncSalesAgents(params: operations['creative_sync_sales_agents']['requestBody']['content']['application/json']): Promise<operations['creative_sync_sales_agents']['responses'][200]['content']['application/json']> {
