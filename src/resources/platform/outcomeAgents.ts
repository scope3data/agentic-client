...
export class OutcomeAgentsResource {
   ...
   */
  async outcomesAgentGetProposals(params: operations['outcomes_agent_get_proposals']['requestBody']['content']['application/json']): Promise<operations['outcomes_agent_get_proposals']['responses'][200]['content']['application/json']> {
   ...
   */
  async outcomesAgentAcceptProposal(params: operations['outcomes_agent_accept_proposal']['requestBody']['content']['application/json']): Promise<operations['outcomes_agent_accept_proposal']['responses'][200]['content']['application/json']> {
   ...
   */
  async outcomesAgentListTactics(params: operations['outcomes_agent_list_tactics']['requestBody']['content']['application/json']): Promise<operations['outcomes_agent_list_tactics']['responses'][200]['content']['application/json']> {
