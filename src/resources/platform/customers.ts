...
export class CustomersResource {
   ...
   */
  async get(params: operations['customer_get']['requestBody']['content']['application/json']): Promise<operations['customer_get']['responses'][200]['content']['application/json']> {
   ...
   */
  async getSeats(params: operations['customer_get_seats']['requestBody']['content']['application/json']): Promise<operations['customer_get_seats']['responses'][200]['content']['application/json']> {
