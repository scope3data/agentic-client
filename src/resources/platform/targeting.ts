...
export class TargetingResource {
   ...
   */
  async countryList(
    params: operations['country_list']['requestBody']['content']['application/json']
  ): Promise<operations['country_list']['responses'][200]['content']['application/json']> {
   ...
   */
  async languageList(
    params: operations['language_list']['requestBody']['content']['application/json']
  ): Promise<operations['language_list']['responses'][200]['content']['application/json']> {
