...
export interface components {
  schemas: {
    ...
    CustomSignalsTargetingProfileInput: {
      /**
    ...
    ListCampaignsInput: {
      ...
      brandAgentId?: number;
      /**
       * @description Filter by campaign status (includes computed statuses: DRAFT, PENDING, COMPLETED)
       * @example DRAFT
       * @enum {string}
       */
    ...
    CreateCampaignInput: {
      ...
      /**
       * @description Initial campaign status (ACTIVE, PAUSED, or ARCHIVED only - defaults to computed status)
       * @example ACTIVE
       * @enum {string}
       */
    ...
    /** @description Parameters for updating a campaign. For status changes, use campaign_pause or campaign_reactivate tools. */
    UpdateCampaignInput: {
      /**
       * @description The unique identifier for the campaign
       * @example cmp_987654321
    ...
    CreativeCreateInput: {
      ...
      /** @example [] */
      tags?: string[] | null;
      status?: ('processing' | 'approved' | 'rejected' | 'pending_review' | 'archived') | null;
      /** @example 100 */
      weight?: number | null;
      /** @example [] */
    ...
    MediaBuyCreateInput: {
            ...
            product_catalog?:
              | ({
                  ...
                  agentic_checkout?: {
                    ...
                    supported_payment_providers?: string[] | null;
                  } | null;
                })
              | null;
            disclaimers?:
      ...
      artifact_webhook?: {
        ...
        token?: string | null;
        authentication: {
          schemes: unknown[] | ('Bearer' | 'HMAC-SHA256')[];
          credentials: string;
        };
      ...
      products: {
        ...
        creatives?:
          | ({
              ...
              tags?: string[] | null;
              status?:
                | ('processing' | 'approved' | 'rejected' | 'pending_review' | 'archived')
                | null;
              weight?: number | null;
              placement_ids?: string[] | null;
            })[]
    ...
    UpdateMediaBuyInput: {
      ...
      status?:
        ...
        | 'ARCHIVED';
      /**
       * @description Campaign start time: "asap" or ISO 8601 date-time
       * @example string
       */
      start_time?: string;
      /**
       * @description Campaign end time: ISO 8601 date-time
       * @example string
       */
      end_time?: string;
      /** @example [] */
    ...
    CreateTacticInput: {
      ...
      /**
       * @description Custom signals targeting profiles. Each profile requires at least one signal in anyOf or noneOf.
       * @example []
       */
      customSignalsTargetingProfiles?: components['schemas']['CustomSignalsTargetingProfileInput'][];
    };
    UpdateTacticInput: {
      /** @example 100 */
      tacticId: number;
      ...
      brandStandardsAgentIds?: number[];
      /**
       * @description Custom signals targeting profiles. Replaces existing profiles. Each profile requires at least one signal in anyOf or noneOf.
       * @example []
       */
      customSignalsTargetingProfiles?: components['schemas']['CustomSignalsTargetingProfileInput'][];
    };
    ...
    AssetList: {
      ...
      items: {
        ...
        brandAgentId: string;
        customerId: number;
        /** @description Permanent public URL to access the asset */
        publicUrl: string;
        tags?: string[];
      }[];
    };
    ...
    CustomSignalsTargetingProfileInputOutput: {
      /**
       * @description Signal IDs to include (OR logic within array)
       * @default []
       */
