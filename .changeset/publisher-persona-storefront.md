...
Also ships a `skills/` directory in the npm package containing `buyer.md`, `partner.md`, and `storefront.md` — plain markdown files that can be loaded directly by Claude Code, coworker, or any tool that supports skill plugins.
